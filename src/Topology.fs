...
let addForGraph (nameMap, nodeMap, internalNames, externalNames, 
                 g : BidirectionalGraph<Node, Edge<Node>>) isAbstract intern name = 
   let typ = 
...
let readTopology (file : string) : TopoInfo * Args.T = 
   ...
   try 
      ...
      for n in topo.Nodes do
         ...
         let args = (concreteNameMap, concreteNodeMap, concreteInternalNames, concreteExternalNames, concreteG)
         addForGraph args false n.Internal n.Name
      ...
      if isAbstract then 
         for n in topo.Abstractnodes do
            ...
            let args = (abstractNameMap, abstractNodeMap, abstractInternalNames, abstractExternalNames, abstractG)
