...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    register<bit<32>>(11) current_seq_no;
    register<bit<32>>(11) decision_seq_no;

    // Decision table
    register<bit<32>>(11) decision_f1;       // Function value
    register<bit<32>>(11) decision_f2;       // Function value

    // Choices table
    register<bit<9>>(11) choices_nhop;      // Next hop port
    register<bit<32>>(11) choices_f1;        // Function value
    register<bit<32>>(11) choices_f2;        // Function value
